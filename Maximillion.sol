...
contract TEther is TToken {
     ...
     */
    constructor(TENTrollerInterface tentroller_,
                InterestRateModel interestRateModel_,
                uint initialExchangeRateMantissa_,
                string memory name_,
                string memory symbol_,
        ...
        initialize(tentroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_);
...
/**
 * @title TENLend's Maximillion Contract
 * @author TENLend
 */
